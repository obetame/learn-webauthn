...
module.exports = (req) => {
      console.log(req);
			...
			//	...req,
			//	response: {
			//		attestationObject: str2ab(req.response.attestationObject),
			//		clientDataJSON: str2ab(req.response.clientDataJSON)
			//	},
			//}
			const webAuthnResponse = req;
